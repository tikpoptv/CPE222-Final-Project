...
HD_PWD='C:/Users/tikpo/OneDrive/Documents/github/CPE222-Final-Project/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log security_clock_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source security_clock_system.tcl -notrace
