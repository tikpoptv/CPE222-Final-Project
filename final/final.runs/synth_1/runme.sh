...
HD_PWD='C:/Users/tikpo/OneDrive/Documents/github/CPE222-Final-Project/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log security_clock_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source security_clock_system.tcl
